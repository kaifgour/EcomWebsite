                ...
                <div class="single__slide animation__style01 slider__fixed--height">
                    <div class="container">
                        <div class="row align-items__center">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb" style="box-shadow:10px 10px 5px lightgrey;">
                                    <img src="images/slider/fornt-img/add.jpg" alt="slider images">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="section__title--2 text-center">
                            ...
                            <p>Trends is like eating, you shouldn't stick to the same menu.
So now shop with us at Dress Code!</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="section__title--2 text-center">
                            ...
                            <p>Our Purpose is to make fashionable clothes for many.</p>
                        </div>
                    </div>
                </div>
                <div class="row">

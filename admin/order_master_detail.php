            ...
            <div class="orders">
               <div class="row">
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
                           <h4 class="box-link"style="font-size:27px;">Order Detail</h4>   
                        </div>
                        <div class="card-body--">
                           ...
                           <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $res=mysqli_query($con,"select distinct(order_details.id),order_details.*,product.name,product.image,`order`.address,`order`.city,`order`.pincode from order_details,product,`order` where order_details.order_id='$order_id'  and product.id=order_details.product_id");
                                        $total_price=0;
                                ...
                                <div id="address_details" style="margin:10px;">
